...
using EssaFuscator.Obfuscator.Control_Flow.Types;

namespace EssaFuscator.Obfuscator.Control_Flow
{
	public class CFlowContext
	{
		public Chunk lChunk;
		...
		public CFlowContext(Chunk lChunk_) =>
			lChunk = lChunk_;
	}
}