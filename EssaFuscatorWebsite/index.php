...
<head>
      ...
      <meta name="description" content="Best Free Obfuscator Out There. EssaFuscator">
      <meta content="#8246F3" data-react-helmet="true" name="theme-color">
      <meta name="twitter:card" content="summary_large_image">
      <script src="https://kit.fontawesome.com/c6a935f6a3.js" crossorigin="anonymous"></script>
...
<body>
   ...
   if (isset($_SESSION['user']['discriminator'])) {
      ?>
      <div class ="essalan"><a href="arabic.php"><img src="img/uae.webp" height="20" width="30" alt="arabiclangauge"></img></a></div> 
      <div class ="essalogout"><a href="/logout.php"><button class="btn btn-primary">Log Out</button height="20" width="30"></a></div>
      <div class="container mt-5">
         ...
         <label>The File To Obfuscate</label>
         <div class="custom-file">
            <input type="file" name="fileUpload" class="custom-file-input" id="chooseFile">
            <label class = "custom-file-label" for="chooseFile">Choose The File</label>
            <small id="primus" class="form-text text-muted">Make Sure There Are No Errors.</small>
         </div>
         <br>
         ...
         <form action="" method="post" enctype="application/x-www-form-urlencoded" class="mb-3">
            <div class="byte-type">
               <br>
               <label for="byteskin">ByteCode Skin</label>
            ...
            <form action="" method="post" enctype="application/x-www-form-urlencoded" class="mb-3">
               <div class="water-mark">
                  <br>
                  <label for="watermark">The Watermark</label>
                  <input type="text" class="form-control" name="wotahmark" id="watermark" placeholder="Watermark">
                  <small id="daddy" class="form-text text-muted">Spaces Are Not Yet Supported</small>
               </div>
      ...
      <label style="font-size:14">Logged In As: <?php echo $_SESSION['user']['username']; ?>#<?php echo $_SESSION['user']['discriminator']; ?> <img src="https://cdn.discordapp.com/avatars/<?php $extention = is_animated($_SESSION['user_avatar']); echo $_SESSION['user_id'] . "/" . $_SESSION['user_avatar'] . $extention; ?>" height="30" width="30" class = "essadad" alt="yourlogo"/></label>
      ...
      <?php
         ...
         <div class="container mt-5">
            <h4 class="text-center mb-5"><a href="https://discord.gg/obfuscate" target="_blank"><img src="img/efus.webp" height="100" width="100" alt="clickmefordiscord"></img></a><br><br>EssaFuscator Online</h4>
            <a href="https://discord.com/api/oauth2/authorize?client_id=819857482699636736&redirect_uri=https%3A%2F%2Fessafuscator.net%2Flogin.php&response_type=code&scope=identify%20guilds.join"><button class="btn btn-primary btn-block mt-4">Login Via Discord</button></a>
         </div>
         <?php
         }
         ?>
